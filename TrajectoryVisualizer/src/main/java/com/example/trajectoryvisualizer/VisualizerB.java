                ...
                .followTrajectorySequence(drive ->
                        {
                            return drive.trajectorySequenceBuilder(new Pose2d(-61.5, -14.6, Math.toRadians(180)))
                                    ...
                                    .lineToSplineHeading(new Pose2d(CmToInch.convert(-120f), CmToInch.convert(60f), Math.toRadians(200f))) //wobble release
                                    .waitSeconds(0.2)
                                    ...
                                    .splineToLinearHeading(new Pose2d(CmToInch.convert(-70f), CmToInch.convert(75f), Math.toRadians(300f)), Math.toRadians(160)) //second wobble release
