                ...
                .followTrajectorySequence(drive ->
                        {
                            return drive.trajectorySequenceBuilder(new Pose2d(-61.5, -14.6, Math.toRadians(180)))
                                    ...
                                    .lineToSplineHeading(new Pose2d(CmToInch.convert(-70f), CmToInch.convert(95f), Math.toRadians(180f))) //wobble release
                                    .waitSeconds(0.2)
                                    ...
                                    .splineToLinearHeading(new Pose2d(CmToInch.convert(10f), CmToInch.convert(125f), Math.toRadians(270f)), Math.toRadians(160)) //second wobble release
