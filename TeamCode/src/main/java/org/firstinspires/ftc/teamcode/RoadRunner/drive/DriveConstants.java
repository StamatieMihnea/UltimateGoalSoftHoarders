...
public class DriveConstants {
     ...
     */
    private static final double RATIO_MULTIPLIER = 0.93678548813;

    public static double WHEEL_RADIUS = 1.9685; // in
    public static double GEAR_RATIO = 0.5*RATIO_MULTIPLIER; // output (wheel) speed / input (motor) speed
     ...
     * empirically tuned.
     */
    public static double kV = 0.0095; //0.0095
    public static double kA = 0.0058; //0.0058
    public static double kStatic = 0.0022; //0.0022
