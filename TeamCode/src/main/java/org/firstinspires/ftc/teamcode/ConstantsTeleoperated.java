...
public class ConstantsTeleoperated {
    ...
    // TODO: Shooter
    //--------------------------------------------------------------------------------------------------------------------//
    public static int shootingSpeed = 1550;
    ...
    public static double rightOffset = 0.105; // Offset for the right servo to maintain shooter aligned
    ...
    //--------------------------------------------------------------------------------------------------------------------//
    public static Vector2d towerCoordinates = new Vector2d(-74, 37);
