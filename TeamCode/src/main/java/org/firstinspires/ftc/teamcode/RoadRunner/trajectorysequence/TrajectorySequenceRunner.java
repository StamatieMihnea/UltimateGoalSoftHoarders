...
public class TrajectorySequenceRunner {
    ...
    DriveSignal update(Pose2d poseEstimate, Pose2d poseVelocity) {
        ...
        if (AutoUtil.shoot_leftEX != null && AutoUtil.shoot_rightEX != null) {
            packet.put("leftShootVelocity", AutoUtil.shoot_leftEX.getVelocity());
            packet.put("rightShootVelocity", AutoUtil.shoot_rightEX.getVelocity());
        }
